...
namespace Frames
{
    ...
    public class Transition
    {
        ...
        /// <summary>
        /// Название кадра, переход на который происходит при возвращении из сцены.
        /// Опциональное поле.
        /// </summary>
        public string ReturnFrame { get; set; }
    ...
    public enum VisibilityPredicateType
    {
        ...
        /// <summary>
        /// Предикат "И НЕ".
        /// Все указанные флаги должны быть не установлены, чтобы предикат вернул true.
        /// </summary>
        AndNot,
        
        /// <summary>
        /// Предикат "ИЛИ НЕ".
        /// Хотя бы один указанный флаг должен быть не установлены, чтобы предикат вернул true.
        /// </summary>
        OrNot
    }
